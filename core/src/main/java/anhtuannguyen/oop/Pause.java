...
public class Pause {
    ...
    public void create() {
        bounds = new Rectangle(Screen.WORLD_W - buttonSize - 20, Screen.WORLD_H - buttonSize - 20, buttonSize,
                buttonSize);
        backgroundRect = new Rectangle(border, border, Screen.WORLD_W - 2 * border, Screen.WORLD_H - 2 * border);
        backRect = new Rectangle((Screen.WORLD_W - button_w) / 2, (Screen.WORLD_H - button_h) / 2 - button_h * 1.5f,
                button_w, button_h);
        restartRect = new Rectangle((Screen.WORLD_W - button_w) / 2, (Screen.WORLD_H - button_h) / 2, button_w,
                button_h);
        resumeRect = new Rectangle((Screen.WORLD_W - button_w) / 2, (Screen.WORLD_H - button_h) / 2 + button_h * 1.5f,
                button_w, button_h);
