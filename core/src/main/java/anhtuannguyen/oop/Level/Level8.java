...
/**
 * Lớp Level8 đại diện cho màn chơi thứ 8 trong game.
...
public class Level8 {
    ...
    /**
     * Constructor khởi tạo màn chơi Level8.
     * @param _play_pause Đối tượng Pause để kiểm soát trạng thái chơi.
     */
    public Level8(Pause _play_pause) {
    ...
    public void create() {
        ...
        ironblock = new Block(0, 0, ball, ROW, COL, map, (int) WORLD_W / COL, (int) WORLD_H / (2 * ROW), new Texture("iron_block_lv8.png"));
