...
public class Resault {
    ...
    public Resault(Viewport _viewport) {
        viewport = _viewport;
    }
    ...
    public void setresault(boolean wingame) {
    ...
    public void create() {
        ...
        resault = new Rectangle((Screen.WORLD_W-1200)/2, (Screen.WORLD_H)/5 + 750, 1200,800);
    }
    ...
    public void render(SpriteBatch batch) {
        ...
        if (!wingame)
        batch.draw(lose, resault.x, resault.y, resault.width, resault.height);
        else 
        batch.draw(win, resault.x, resault.y, resault.width, resault.height);
        if (!back_touch)
