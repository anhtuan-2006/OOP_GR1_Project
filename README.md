...
Người chơi điều khiển một thanh chắn (bar) để giữ quả bóng không rơi khỏi màn hình, đồng thời phá vỡ toàn bộ các khối gạch (block) để hoàn thành màn chơi. Trò chơi bao gồm nhiều màn với độ khó khác nhau, cùng các tính năng như tạm dừng, chọn màn, điều chỉnh âm lượng và hiển thị điểm số.
 Tính năng nổi bật
 - Đa dạng block:
Block thường (phá vỡ 1 lần)
Block sắt (không thể vỡ)
Block di chuyển 
Điều khiển mượt mà:
Hỗ trợ bàn phím để điều khiển thanh chắn
Tạm dừng và tiếp tục:
Có thể tạm dừng game và quay lại bất kỳ lúc nào
- Cài đặt âm thanh:
Tuỳ chỉnh âm lượng và loại nhạc nền
- Tuỳ chỉnh số mạng:
Chọn số mạng ban đầu (1, 3 hoặc 5) trong phần cài đặt
- Hiện thị rank người chơi:
Lưu lại tên và điểm số để hiện thị rank

- Điểm số và điểm cao nhất:
Hiển thị điểm hiện tại và lưu trữ tên và điểm cao nhất
- Chọn màn chơi:
...
2.	Mở bằng IDE:
- Import project như một Gradle project (nếu có cấu hình sẵn)
Hoặc cấu hình LibGDX thủ công nếu không dùng Gradle
Đối tượng:
...
Video giới thiệu
https://drive.google.com/file/d/12-NFJd-oXdav_rplkF4GJ8VBtCi_HQjG/view?usp=sharing
